...
contract PercentageMathTest is Test {
    ...
    function test_AddPercent_Basic() public pure {
        ...
        console.log("Add Percent Test: %s + %s%% = %s", base, percentage, result);
    ...
    function test_AddPercent_ZeroBase() public pure {
        ...
        console.log("Add Percent Zero Base: 0 + %s%% = %s", percentage, result);
    ...
    function test_AddPercent_ZeroPercentage() public pure {
        ...
        console.log("Add Percent Zero Percentage: %s + 0%% = %s", base, result);
    ...
    function test_SubPercent_Basic() public pure {
        ...
        console.log("Sub Percent Test: %s - %s%% = %s", base, percentage, result);
        console.log("Expected: %s", expected);
    ...
    function test_Percent_Basic() public pure {
        ...
        console.log("Percent Test: %s%% of %s = %s", percentage, base, result);
        console.log("Expected: %s", expected);
    ...
    function test_PercentUp_Rounding() public pure {
        ...
        console.log("Percent Up Test: %s%% of %s = %s (rounded up)", percentage, base, result);
    ...
    function test_CalculatePercentChange_Decrease() public pure {
        ...
        console.log("Percent Change Decrease: %s -> %s = %s bps", oldValue, newValue, result);
    ...
    function test_Compound_Simple() public pure {
        ...
        console.log("Compound Test: %s at %s%% for %s periods = %s", principal, rate, periods, result);
        console.log("Expected: %s", expected);
    ...
    function test_Compound_MultiplePeriods() public pure {
        ...
        uint256 result = PercentageMath.compound(principal, rate, periods);
        uint256 expected = 1020.1 ether / 1 ether; // 1000 * 1.01^2 ≈ 1020.1
        
        console.log("Compound Multiple: %s at %s%% for %s periods = %s", principal, rate, periods, result);
        console.log("Expected: ~%s", expected);
    ...
    function test_AprToDaily() public pure {
        ...
        console.log("APR to Daily: %s%% APR = %s%% daily", apr, result);
    ...
    function test_UtilizationRate() public pure {
        ...
        console.log("Utilization Rate: %s borrowed, %s available = %s bps", borrowed, available, result);
    ...
    function test_LiquidationPriceLong() public pure {
        ...
        console.log("  Entry: %s, Collateral: %s, Size: %s, MM: %s bps", entryPrice, collateral, positionSize, maintenanceMargin);
    ...
    function test_LiquidationPriceShort() public pure {
        uint256 entryPrice = 2000;
        uint256 collateral = 1000;
        uint256 positionSize = 10;
        uint256 maintenanceMargin = 500; // 5%
    ...
    function test_CalculatePnlPercent_LongProfit() public pure {
        ...
        console.log("Pnl Percent Long Profit: %s -> %s = %s bps", entryPrice, exitPrice, result);
    ...
    function test_CalculatePnlPercent_ShortProfit() public pure {
        ...
        console.log("Pnl Percent Short Profit: %s -> %s = %s bps", entryPrice, exitPrice, result);
        console.log("Expected: %s bps (10%% profit)", expected);
    ...
    function test_SlippageBounds_Buy() public pure {
        ...
        console.log("  Price: %s, Slippage: %s bps, Min: %s, Max: %s", price, slippage, minPrice, maxPrice);
    ...
    function test_CalculateFee() public pure {
        ...
        console.log("Calculate Fee: %s at %s bps = %s", amount, feeBps, result);
        console.log("Expected: %s", expected);
    ...
    function test_AmountAfterFee() public pure {
        ...
        console.log("Amount After Fee: %s - %s bps fee = %s", amount, feeBps, result);
        console.log("Expected: %s", expected);
    ...
    function test_AmountBeforeFee() public pure {
        ...
        console.log("Amount Before Fee: %s net with %s bps fee = %s", netAmount, feeBps, result);
        console.log("Expected: %s", expected);
    ...
    function test_IsValidPercentage() public pure {
        ...
        console.log("Is Valid Percentage: 5000 bps = %s, 10001 bps = %s", valid, invalid);
    ...
    function testFuzz_AddSubPercent_Inverse(uint256 base, uint256 percentage) public pure {
        ...
        console.log("  Base: %s, Percentage: %s bps", base, percentage);
        console.log("  After Add: %s, After Sub: %s", afterAdd, afterSub);
    ...
    function testFuzz_Percent_Proportional(uint256 base, uint256 percentage) public pure {
        ...
        console.log("Fuzz Percent Proportional: %s%% of %s = %s", percentage, base, result);
    ...
    function testFuzz_UtilizationRate_Bounds(uint256 borrowed, uint256 available) public pure {
        ...
        console.log("  Borrowed: %s, Available: %s, Utilization: %s bps", borrowed, available, utilization);
    ...
    function testFuzz_AmountBeforeAfterFee_Consistent(uint256 amount, uint256 feeBps) public pure {
        ...
        console.log("  Original: %s, Fee: %s bps", amount, feeBps);
        console.log("  After Fee: %s, Reconstructed: %s", afterFee, beforeFee);
    ...
    function test_Gas_PercentCalculation() public pure {
    ...
    function test_Gas_CompoundCalculation() public pure {
        uint256 gasBefore = gasleft();
    ...
    function test_EdgeCase_VerySmallPercentages() public pure {
        ...
        console.log("Edge Case - Tiny Percentage: 0.01%% of %s = %s", base, result);
    ...
    function test_EdgeCase_MaxValues() public pure {
        ...
        console.log("Edge Case - Max Values: 50%% of %s = %s", maxSafe, result);
